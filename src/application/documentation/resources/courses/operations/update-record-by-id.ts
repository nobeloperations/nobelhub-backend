...
import { UpdateCourseDto } from '@application/dtos';
import { UPDATE_COURSE_DTO_EXAMPLE, API_RESPONSE_DTO_EXAMPLE } from '.../examples';
...
export const UPDATE_COURSE_BY_ID = {
  ...
  responses: {
    ...
    [HttpStatus.CONFLICT]: {
      ...
      description: 'A course with the same teachableId already exists' // Changed conflict reason
    }
  }
};
